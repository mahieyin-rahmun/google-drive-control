		...
		if not creds or not creds.valid:
			if creds and creds.expired and creds.refresh_token:
				...
				try:
					...
					raise Exception("Head over to https://developers.google.com/drive/api/v3/quickstart/python \nto enable the GDrive API and obtain your 'credentials.json' first, \nwhich must be put under the 'credentials' folder")
